...
## 演示地址
[https://xueyes.github.io][1]

## 项目源码
[https://github.com/xueyes/vblog][3]
...
## 快速使用
搭建博客只需2步
- 点击github头像旁边的 "+" 号 选择 ```Import repository ```克隆地址填 ```https://github.com/xueyes/xueyes.github.io ```项目名填 ```你的用户名.github.io ```
...
现在 ```https://你的用户名.github.io``` 就是你的个人博客了,例如[https://xueyes.github.io][1]
...
作者 *xueyes*
  ...
  [1]: https://xueyes.github.io
  [2]: https://github.com/xueyes/xueyes.github.io
  [3]: https://github.com/xueyes/vblog
